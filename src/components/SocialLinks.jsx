...
// Circular social buttons with subtle borders; glow + lift on hover.
const ICONS = {
  github: (
...
const LINKS = [
  ...
  { key: "email", label: "Email", href: SOCIALS.email, external: false },
  { key: "x", label: "X", href: "https://x.com/", external: true },
];
