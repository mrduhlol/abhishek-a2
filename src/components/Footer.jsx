    ...
    <footer className="border-t border-line" aria-label="Footer">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 py-10 md:flex-row md:items-center md:justify-between md:px-8">
        <div>
          ...
          <p className="mt-1 font-mono text-[11px] tracking-[0.2em] text-muted">CSE — CYBERSECURITY</p>
        </div>
        <p className="text-sm text-muted">© 2026 Abhishek A.</p>
        <ul className="flex items-center gap-6 text-sm text-muted">
          ...
          <li>
            <a href={SOCIALS.email} className="transition-colors hover:text-ink">
              Email
            </a>
          </li>
        </ul>
